import { startSessionController, stopSessionController, isSessionCurrent } from '../auth/session-controller.js';
import { getState, patchState } from '../core/state.js';
import { renderSignedIn, showPhase, showAuthError } from '../ui/auth-ui.js';
import { mountAcademicUI, clearAcademicUI } from '../ui/academic-ui.js';
import { mountHomeUI, clearHomeUI } from '../ui/home-ui.js';
import { mountProductivityUI, clearProductivityUI } from '../ui/productivity-ui.js';
import { mountStreakUI, clearStreakUI } from '../streaks/streak-ui.js';
import { mountPreferencesUI, clearPreferencesUI } from '../preferences/preferences-ui.js';
import { mountSearchUI, clearSearchUI } from '../search/search-ui.js';
import { mountNotificationUI, clearNotificationUI } from '../notifications/notification-ui.js';
import { mountRevisionUI, clearRevisionUI } from '../revision/revision-ui.js';
import { mountInsightsUI, clearInsightsUI } from '../insights/insights-ui.js';
import { authErrorMessage } from '../core/errors.js';
import { mountAdminUI, clearAdminUI } from '../admin/admin-ui.js';
